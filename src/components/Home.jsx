...
import image from "../pictures/pexels-sheila-731217.jpg"
    ...
    <>
      ...
      <div data-aos="fade-right" className="main">
        <div className="intro">
          <div className="part-1">
            <div className="title">
              <h1 id="title-h">Airport Item Tracker</h1>
      ...
      <div data-aos="fade-right">
        <Container fluid className="total-inspiration">
          ...
          <Row className="inspiration">
            ...
            <p>
              We have all experienced the anxiety of misplacing or losing important belongings .The airport item tracker website is a web-based platform designed to assist travellers in listing lost items at airports .
            </p>
      ...
      {/* <div className="footer">
        <div className="social-icon">
          ...
          <a
            href="https://www.linkedin.com/in/shiva-koushik-reddy-ragi-610a93232/"
            target="_blank"
            rel="noopener noreferrer"
          >
        ...
        <div className="personal-info">
          ...
          <h4>
            <span className="symbol">&#60;</span>R.SHIVA KOUSHIK REDDY
          ...
          {/* <h4><span className="tab">20311A05B1</span>&nbsp;<span className="tab">20311A05B1</span>&nbsp;<span className="tab">20311A05B1</span></h4> */}
          {/* <a
        ...
        <h5 style={{ textAlign: "center" }}>
          Copyright © 2022 RSKR. All rights reserved.
        </h5>
      </div> */}
      {/* <div className="About">
        <div>
